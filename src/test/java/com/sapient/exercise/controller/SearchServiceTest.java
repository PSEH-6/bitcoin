...
//        map.put(formatter.parse("01/01/2011"),"233.2");
//        map.put(formatter.parse("01/02/2011"),"231.2");
//        when(bitcoinDataService.getHistoricalData(formatter.parse("01/01/2011"),formatter.parse("01/02/2011"),"INR")).thenReturn(map);
